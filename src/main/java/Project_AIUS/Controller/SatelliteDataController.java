...
public class SatelliteDataController extends BaseController implements Initializable {
    ...
    public SatelliteDataController(ViewFactory viewFactory, String fxmlName) {
